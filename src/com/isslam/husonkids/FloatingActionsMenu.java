...
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class FloatingActionsMenu extends ViewGroup {
  ...
  @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) private class LayoutParams extends ViewGroup.LayoutParams {
